        ...
        <div class="house-col col-md-4">
            <div id="house-{{$house->id}}" class="house">
                ...
                <div class="owner-container">
                    <a class="no-style" href="{{$house->url}}" title="{{$house->owner->first_name}}" target="_blank">
                ...
                <div class="house-users text-center text-nowrap margin-top-20">
                    ...
                    @foreach($house->rooms as $room)
                        @foreach($room->acceptedUsers as $user)
                            ...
                            <div class="col-auto">
                                <a class="no-style" href="{{$house->url}}" title="{{$user->first_name}}">
                ...
                <div class="house-price margin-top-40 text-right d-none d-sm-block">
                    ...
                    <a href="{{$house->url}}" class="btn btn-dark btn-sm margin-left-5" title="Visualizza l'appartamento" target="_blank">Visualizza L'appartamento</a>
                </div>
                ...
                <div class="house-price margin-top-40 text-right d-block d-sm-none text-center">
                    ...
                    <a href="{{$house->url}}" class="btn btn-success margin-top-10 margin-left-5" title="Visualizza l'appartamento" target="_blank">Visualizza L'appartamento</a>
                </div>
            </div>
        </div>
        @empty
